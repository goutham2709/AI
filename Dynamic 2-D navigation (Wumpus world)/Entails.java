...
public class Entails {
    ...
    public LinkedList getSymbols(Logical_expression knowledge_base, HashMap model)
        {
        ...
        public boolean TT_Entails(Logical_expression knowledge_base,Logical_expression statement, HashMap model)
        {
        ...
        public boolean TT_Check_All(Logical_expression knowledge_base, Logical_expression statement, LinkedList symbol, HashMap model)
        {
            if(symbol.isEmpty())
            {
        ...
        public boolean PL_True(Logical_expression statement, HashMap model)
        {
            ...
            {
                Logical_expression leftExpression, rightExpression;
                ...
                for( Enumeration e = statement.getSubexpressions().elements(); e.hasMoreElements(); ) 
                {
                    if(++count == 1)
                    {
                        leftExpression = ( Logical_expression )e.nextElement();
                        left_pl_value = PL_True(leftExpression, model);
                    }
                    else if(++count >= 2)
                    {
                        rightExpression = ( Logical_expression )e.nextElement();
